...
public class SubStrCombinationFinderTest {
	...
	public void testCombinationNoRe() {
			...
			assertEquals(Arrays.asList(Arrays.asList("2", "3"), Arrays.asList("23")), 
					finder.findAllCombinationNoRecursion("23"));

			assertEquals(Arrays.asList(Arrays.asList("2", "3", "4"), Arrays.asList("2", "34"),
					Arrays.asList("23", "4"), Arrays.asList("234")), 
